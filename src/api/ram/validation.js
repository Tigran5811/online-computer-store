...
export const createValidation = () => [
    ...
    body('color').isLength({ min: 2, max: 10 }).withMessage(errorMessage.fromToString(2, 10)),
    body('memorySpeed').isInt({ min: 1, max: 10000 }).withMessage(errorMessage.fromToInteger(1, 10000)),
    body('memorySize').isInt({ min: 1, max: 10000 }).withMessage(errorMessage.fromToInteger(1, 10000)),
